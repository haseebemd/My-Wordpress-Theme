...
class Listing_Functions {
	...
	public function classima_listing_archive_grid( $col_class, $map ) {
		...
		$col_class .= isset( RDTheme::$options['grid_tablet_column'] ) ? ' col-md-' . RDTheme::$options['grid_tablet_column'] . ' col-sm-'
		                                                                 . RDTheme::$options['grid_tablet_column'] : ' col-md-6 col-sm-6';
